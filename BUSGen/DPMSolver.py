# The source code is from https://github.com/LuChengTHU/dpm-solver
import torch
...
def model_wrapper(
    ...
    def get_model_input_time(t_continuous):
        ...
        if noise_schedule.schedule == 'discrete':
            ...
            return ((t_continuous - 1. / noise_schedule.total_N) * noise_schedule.total_N).long()
        else:
            return t_continuous
